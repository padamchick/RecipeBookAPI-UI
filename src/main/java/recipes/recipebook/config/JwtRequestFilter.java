package recipes.recipebook.config;//package aviationModelling.config;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    public JwtRequestFilter(@Qualifier("userDetailsServiceImpl") UserDetailsService userService, JwtTokenUtil jwtTokenUtil) {
