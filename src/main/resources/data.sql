...
INSERT INTO recipe (name, description, image, recipe_book_id) VALUES ('Soczysta pierś z indyka','Cebulę pokroić w drobną kostkę, dodać składniki marynaty, wymieszać. Natrzeć mięso i zostawić w naczyniu do pieczenia (na dno którego wlać łyżkę oleju) na całą noc.
...
INSERT INTO recipe (name, description, image, recipe_book_id) VALUES ('Ciastka owsiane','Masło wyjąć z lodówki około godzinę przed rozpoczęciem pracy.
...
INSERT INTO recipe (name, description, image, recipe_book_id) VALUES ('Kurczak po meksykańsku','1. Wstawiamy ryż do gotowania
