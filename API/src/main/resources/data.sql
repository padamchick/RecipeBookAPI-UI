...
INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Shakshuka','Chorizo pokroić na 4, podsmażyć. Dodać pomidory, przyprawić. Wbić jajka i smażyć pod przykryciem około 5-7 minut na dużej mocy kuchenki. Podać z pokrojoną fetą i szczypiorkiem.','https://i2.wp.com/www.downshiftology.com/wp-content/uploads/2018/12/Shakshuka-19.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Big Tuna','Tuńczyka odsączyć. Ugotowane jajka i cebulę pokroić w drobną kostkę. Wszystko wymieszać, doprawić solą i pieprzem do smaku. Podawać na podpieczonej bagietce lub grzance z kiełkami.','https://dinnerthendessert.com/wp-content/uploads/2019/01/Tuna-Salad.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Kurczak Curry','Kurczaka pokroić w paski, cebulę w piórka. Wymieszać z czosnkiem, vegetą i wstawić do lodówki na 3h. Z pozostałych składników zrobić sos. Cały sos wymieszać z mięskiem z lodówki. Włożyć do naczynia żaroodpornego. Piec 90 minut w 180 stopniach C. Od czasu do czasu przemieszać, a ostatnie pół godziny piec bez przykrywki.','https://s3.przepisy.pl/przepisy3ii/img/variants/767x0/curry-z-kurczaka.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Pasztet soczewicowy z żurawiną','Cebulę pokroić w kostkę, na patelni rozgrzać olej i dodać cebulę razem z liściem laurowym zielem angielskim oraz goździkami. Smażyć na niedużym ogniu do czasu, aż cebula się zeszkli, wtedy wyjąć przyprawy i wyrzucić.
...
Piekarnik rozgrzać do 180 stopni. Masę przełożyć do foremki (keksówka 20x11cm) wyłożonej papierem do pieczenia, wyrównać i piec przez 40 – 45 minut. Piec do momentu aż będzie miał złotą skorupkę, pasztet po upieczeniu jest płynny, należy studzić przez całą noc w foremce, a rano wyjąć pasztet z formy i podawać.','https://static.gotujmy.pl/ZDJECIE_PRZEPISU_ETAP/pasztet-z-zurawina-387035.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Ciasto marchewkowe','Mąkę przesiewamy z proszkiem i sodą. Orzechy prażymy na suchej patelni. Jajka miksujemy z solą na białą masę. Następnie na niskich obrotach miksujemy i dodajemy mąkę, olej, cukier i wanilię. Marchewkę, daktyle i orzechy mieszamy z 1 łyżeczką mąki. Dodajemy do ciasta i delikatnie mieszamy.
Pieczemy w blaszce 10x20 cm około 50-55 minut w 175 stopniach C do suchego patyczka.','https://static.smaker.pl/photos/a/0/1/a01ad418f17b38f5646f498bff68877d_362117_582af6e47e565_wm.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Soczysta pierś z indyka','Cebulę pokroić w drobną kostkę, dodać składniki marynaty, wymieszać. Natrzeć mięso i zostawić w naczyniu do pieczenia (na dno którego wlać łyżkę oleju) na całą noc.
...
Upieczone mięso wyjąć z piekarnika, przykryć i zostawić na około 10 minut. Podawać pokrojone z sosem z pieczenia.','https://static.smaker.pl/photos/a/1/9/a1953f96295237c0ce6d9c8e08910084_289369_527fe60936379_wm.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Ciastka owsiane','Masło wyjąć z lodówki około godzinę przed rozpoczęciem pracy.
...
Piec 15-17 minut w 170 stopniach z termoobiegiem.','https://d3iamf8ydd24h9.cloudfront.net/pictures/articles/2018/02/38319-v-900x556.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Kurczak po meksykańsku','1. Wstawiamy ryż do gotowania
...
1 porcja: 862 kcal (B: 45g, W: 74g, T: 40g (w tym nienasycone 38g))','https://cdn.katalogsmakow.pl/2018/10/15/0x600/kurczak-po-meksykansku.741420.jpg',1)

INSERT INTO recipe (name, description, image_path, recipe_book_id) VALUES ('Chowder kukurydziany','Przygotowanie:
